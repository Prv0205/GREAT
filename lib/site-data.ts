...
export const subjects: Subject[] = [
  {
    ...
    duration: '2 hrs / week',
    topics: ['Number & Algebra', 'Geometry', 'Trigonometry', 'Statistics', 'Problem Solving'],
    description:
  ...
  },
  {
    ...
    rating: 'H1–H3 support',
    duration: '2 hrs / week',
    topics: ['Comprehension', 'Creative Writing', 'Poetry', 'Comparative Study', 'Exam Technique'],
    description:
  ...
  },
  {
    ...
    rating: 'H1–H3 support',
    duration: '3 hrs / week',
    topics: ['Physics', 'Chemistry', 'Biology', 'Experiments', 'Exam Technique'],
    description:
  ...
  },
  {
    ...
    rating: 'H1–H3 support',
    duration: '2 hrs / week',
    topics: ['An Bhéaltriail', 'Cluastuiscint', 'Prós & Filíocht', 'Aiste', 'Comhrá'],
    description:
